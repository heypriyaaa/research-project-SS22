...
#png(file = "./histogram_freq_poly_distance_tumor_cell.png")
ggplot(tumor_data, aes(x = Distance)) +
  geom_freqpoly(color = "red") +
  geom_histogram(color = "black", alpha = 0.5) +
  ylab("Count") +
  labs(title = "Histogram + Frequency Polygon of Distance to Tumor cell")
#dev.off()

# ggplot of histogram and density line of tumor data H+
#png(file = "./histogram_freq_poly_distance_tumor_cell_hpositive.png")
...
ggplot(tumor_data_hpositive, aes(x = Distance)) +
  ...
  ylab("Count") +
  labs(title = "Histogram + Frequency Polygon of Distance to Tumor cell H+")
#dev.off()

# ggplot of histogram and density line of tumor data H-
#png(file = "./histogram_freq_poly_distance_tumor_cell_hnegative.png")
...
#png(file = "./histogram_freq_poly_distance_t_cell.png")
ggplot(t_cell_data, aes(x = Distance)) +
  geom_freqpoly(color = "red") +
  geom_histogram(color = "black", alpha = 0.5) +
  ylab("Count") +
  labs(title = "Histogram + Frequency Polygon of Distance to T-cell")
#dev.off()

# ggplot of histogram and density line of t cell data H+
#png(file = "./histogram_freq_poly_distance_t_cell_hpositive.png")
t_cell_data_hpositive <- t_cell_data[t_cell_data$Cell_type == "H+",]
ggplot(t_cell_data_hpositive, aes(x = Distance)) +
  geom_freqpoly(color = "#00BFC4") +
  geom_histogram(color = "#00BFC4", fill = "#00BFC4", alpha = 0.5) +
  ylab("Count") +
  labs(title = "Histogram + Frequency Polygon of Distance to T cell H+")
#dev.off()

# ggplot of histogram and density line of t cell data H-
#png(file = "./histogram_freq_poly_distance_t_cell_hnegative.png")
